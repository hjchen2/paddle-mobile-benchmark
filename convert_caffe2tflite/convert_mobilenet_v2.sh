...
cp ../tf_models/mobilenet_v2_1.0_224/mobilenet_v2_1.0_224_frozen.pb ./frozen_eval_graph.pb

# convert graph pb file to tflite format
rm -rf ../tflite_models/mobilenet_v2
mkdir -p ../tflite_models/mobilenet_v2

# float
../../tensorflow/bazel-bin/tensorflow/contrib/lite/toco/toco \
  --input_file=./frozen_eval_graph.pb \
  --output_file=../tflite_models/mobilenet_v2/mobilenet_v2.tflite \
...
../../tensorflow/bazel-bin/tensorflow/contrib/lite/toco/toco \
  --input_file=./frozen_eval_graph.pb \
  --output_file=../tflite_models/mobilenet_v2/mobilenet_v2_8bit.tflite \
  --input_format=TENSORFLOW_GRAPHDEF --output_format=TFLITE \
